          ...
          <Grid container justifyContent="space-between">
            ...
            <Grid item >
              <Search>
                ...
                <form onSubmit={(e) => {
                  e.preventDefault();
                  props.handleSearch(e.target[0].value)
                }}>
                  <StyledInputBase
                    placeholder="Search…"
            ...
            <Grid item>
              <Grid container spacing={1}>
                ...
                <Grid item>
                  <To to="/products" ><Button onClick={() => { props.setPage(0) }} style={{ color: 'white' }} >Home</Button></To>
                  <Button onClick={() => { props.setPage(1) }} style={{ color: 'white' }} >Add Product</Button>
